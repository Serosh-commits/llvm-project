...
class FindUsageOfThis : public DynamicRecursiveASTVisitor {
  ASTContext &Ctxt;
...
public:
  ...
  bool VisitUnresolvedMemberExpr(UnresolvedMemberExpr *) override {
  ...
  bool VisitCXXConstCastExpr(CXXConstCastExpr *) override {
